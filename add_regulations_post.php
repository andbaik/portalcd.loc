...
<div class="form_reg">
    ...
    <form class="forms_item" action="ajax/add_order.php" method="POST" enctype="multipart/form-data">
        ...
        <h3>Поля со звездочкой обязательны для заполнения!</h3>
            ...
            <div class="first_section">
                ...
                <div class="row date">
                    ...
                    <input type="date" name="date_given" id="date_given" placeholder="Дата выдчи">
                </div>
            ...
            <div class="second_section">
                <div class="row file_add">
                    ...
                    <input type="file" name="file" id="mainImageFile" placeholder="Файл">
                </div>
