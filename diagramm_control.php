...
$title = "Контроль мероприятий [диаграмма]";
...
<body>
  ...
  <main class="main">
    <div class="container">
      <h1>Контроль мероприятий [диаграмма]</h1>
      ...
      <table class="iksweb" style="table-layout: fixed; width: 100%">
        ...
        <thead>
          <tr>
            <th class="tg-lboi" rowspan="2">№</th>
            <th class="tg-lboi" rowspan="2">Документ</th>
            <th class="tg-lboi" rowspan="2">Файл</th>
            <th class="tg-cly1" rowspan="2">Пункт</th>
