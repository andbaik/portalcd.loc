            ...
            <form class="forms_item" id="data" method="POST" enctype="multipart/form-data">
                ...
                <div class="second_section">
                    ...
                    <div class="row own">
                        ...
                        <input type="text" name="whom_given" id="whom_given" placeholder="Укажите ФИО">
                    </div>
                </div>
                ...
                <div class="second_section">
                    <div class="row documents">
                        ...
                        <input type="text" name="err_doc" id="err_doc" placeholder="Укажите какие документы нарушены">
                    </div>
                    <div class="row err">
                        <label for="err_item">* Пункты нарушенных документов</label>
                        <input type="text" name="err_item" id="err_item" placeholder="Укажите нарушенные пункты">
                    </div>
                </div>
